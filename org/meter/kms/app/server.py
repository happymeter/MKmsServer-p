...
import logging
import os
import org.meter.kms.rpc.rpcBind
import org.meter.kms.rpc.rpcRequest
from org.meter.kms.rpc.dcerpc import MSRPCHeader
from org.meter.kms.rpc.rpcBase import rpcBase
from org.meter.kms.tools.formatText import shell_message
...
def main():
    print("This is a kms Server for active Microsoft softwares.");
...
The default is \"364F463A8863D35F\" or type \"random\" to auto generate the HWID.', type=str)
    parser.add_argument("-v", "--loglevel", dest="loglevel", action="store", default="INFO",
    ...
    print("HWID: %s" % binascii.b2a_hex(config['hwid']).decode('utf-8').upper())
    print('The Kms Server is running......\r\nYou can connect this server to active you software.');
    server.serve_forever();#线程阻塞
