...
import org.meter.kms.tools.filetimes, org.meter.kms.rpc.rpcBind, org.meter.kms.rpc.rpcRequest
from org.meter.kms.rpc.dcerpc import MSRPCHeader, MSRPCBindNak, MSRPCRequestHeader, MSRPCRespHeader
from org.meter.kms.kmsBase import kmsBase, UUID
from org.meter.kms.request.kmsRequestV4 import kmsRequestV4
from org.meter.kms.request.kmsRequestV5 import kmsRequestV5
from org.meter.kms.request.kmsRequestV6 import kmsRequestV6
...
def createKmsRequestBase():
        ...
        requestDict['requestTime'] = org.meter.kms.tools.filetimes.dt_to_filetime(datetime.datetime.utcnow())
