...
import org.meter.kms.tools.aes
...
class kmsRequestV5(kmsBase):
        ...
        def decryptRequest(self, request):
                ...
                decrypted = org.meter.kms.tools.aes.strip_PKCS7_padding(decrypted)
        ...
        def encryptResponse(self, request, decrypted, response):
                ...
                padded = org.meter.kms.tools.aes.append_PKCS7_padding(str(responsedata).encode('latin-1')) #*2to3*
                moo = org.meter.kms.tools.aes.AESModeOfOperation()
                moo.aes.v6 = self.v6
        ...
        def generateRequest(self, requestBase):
                ...
                padded = org.meter.kms.tools.aes.append_PKCS7_padding(str(decrypted).encode('latin-1')) #*2to3*
