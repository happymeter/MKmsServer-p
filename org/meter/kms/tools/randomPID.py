...
import org.meter.kms.tools.kmsPidGenerator
...
# Responses.
response = org.meter.kms.tools.kmsPidGenerator.epidGenerator(applicationId, versionMajor, lcid)
response2 = org.meter.kms.tools.kmsPidGenerator.epidGenerator(applicationId2, versionMajor, lcid)
response3 = org.meter.kms.tools.kmsPidGenerator.epidGenerator(applicationId3, versionMajor, lcid)
